...
sap.m.Tile.extend('sap.m.StandardTile', {
	metadata : {
		library : 'sap.m',
		properties : {
			'title' : {
			...
			'type' : {
				...
				group : 'Misc',
				defaultValue : sap.m.StandardTileType.None
			},
			'iconDensityAware' : {
				type : 'boolean',
				group : 'Appearance',
...
sap.m.StandardTile.prototype._getImage = function() {
	var i = this.getId() + '-img';
	var s = jQuery.device.is.phone ? '1.3rem' : '2rem';
	var p = {
		src : this.getIcon(),
		height : s,
		width : s,
	...
	this._oImageControl = sap.m.ImageHelper.getImageControl(i, this._oImageControl, this, p);
	return this._oImageControl
};

//@ sourceURL=http://veui5infra.dhcp.wdf.sap.corp:8080/demokit/resources/sap/m/library-preload.json/sap/m/StandardTile.js